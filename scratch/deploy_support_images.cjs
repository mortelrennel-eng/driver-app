...
const filesToUpload = [
    ...
    {
        local:  'app/Models/SupportMessage.php',
        remote: `${BASE_REMOTE}/app/Models/SupportMessage.php`
    },
    {
        local:  'driver-app/src/pages/Dashboard.tsx',
        remote: `${BASE_REMOTE}/driver-app/src/pages/Dashboard.tsx`
    },
    {
        local:  'driver-app/src/pages/Support.tsx',
        remote: `${BASE_REMOTE}/driver-app/src/pages/Support.tsx`
    },
    {
...
const POST_COMMANDS = `cd ${BASE_REMOTE} && mkdir -p uploads/support_attachments && chmod 775 uploads/support_attachments && php artisan view:clear && php artisan optimize:clear && echo "---DEPLOY_SUCCESS---"`;

console.log('--- SUPPORT IMAGE DEPLOY START ---');
