...
conn.on('ready', () => {
    conn.exec(`cat << 'EOF' > /home/u747826271/domains/eurotaxisystem.site/public_html/test_req.php\n${PHP_TEST}\nEOF\nphp /home/u747826271/domains/eurotaxisystem.site/public_html/test_req.php`, (err, stream) => {
        if (err) throw err;
