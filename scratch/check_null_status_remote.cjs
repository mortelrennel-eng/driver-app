...
const command = `php /home/u747826271/domains/eurotaxisystem.site/public_html/artisan tinker --execute="echo json_encode(DB::table('maintenance')->whereNull('status')->count());"`;
