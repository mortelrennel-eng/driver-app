...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                <a href="<?php echo e(route('analytics.history')); ?>"
                ...
                <a href="<?php echo e(route('analytics.export.csv', ['type' => 'revenue', 'date_from' => $date_from, 'date_to' => $date_to])); ?>"
                ...
                <a href="<?php echo e(route('analytics.export.csv', ['type' => 'drivers', 'date_from' => $date_from, 'date_to' => $date_to])); ?>"
                ...
                <a href="<?php echo e(route('analytics.export.csv', ['type' => 'maintenance', 'date_from' => $date_from, 'date_to' => $date_to])); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm hover:shadow-xl hover:border-indigo-200 hover:-translate-y-1 transition-all duration-300 group">
                ...
                <div class="h-2 bg-slate-100 rounded-full overflow-hidden p-0.5 border border-slate-200/30">
                    <div class="h-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full transition-all duration-1000 shadow-[0_0_8px_rgba(99,102,241,0.5)]" style="width: <?php echo e($fleet_utilization); ?>%"></div>
                </div>
            ...
            <div class="lg:col-span-2 bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-sm">
                ...
                <div class="p-8">
                    ...
                    <div class="flex h-10 w-full rounded-3xl overflow-hidden shadow-inner border border-slate-200/40 p-1 bg-slate-50 gap-1 mb-8">
                        <?php if($actPct > 0): ?>
                            <div class="h-full bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-l-2xl transition-all hover:scale-[1.01] hover:brightness-105 cursor-help" style="width: <?php echo e($actPct); ?>%" title="Active: <?php echo e($fleet_pulse['active_units']); ?>"></div>
                        <?php endif; ?>
                        <?php if($idlPct > 0): ?>
                            <div class="h-full bg-gradient-to-r from-slate-300 to-slate-400 transition-all hover:scale-[1.01] hover:brightness-105 cursor-help" style="width: <?php echo e($idlPct); ?>%" title="Idle: <?php echo e($fleet_pulse['idle_units']); ?>"></div>
                        <?php endif; ?>
                        <?php if($mntPct > 0): ?>
                            <div class="h-full bg-gradient-to-r from-amber-400 to-amber-500 transition-all hover:scale-[1.01] hover:brightness-105 cursor-help" style="width: <?php echo e($mntPct); ?>%" title="Maintenance: <?php echo e($fleet_pulse['maintenance']); ?>"></div>
                        <?php endif; ?>
                        <?php if($surPct > 0): ?>
                            <div class="h-full bg-gradient-to-r from-rose-400 to-rose-500 rounded-r-2xl transition-all hover:scale-[1.01] hover:brightness-105 cursor-help" style="width: <?php echo e($surPct); ?>%" title="Surveillance: <?php echo e($fleet_pulse['surveillance']); ?>"></div>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="flex gap-4">
                            ...
                            <p class="text-sm text-indigo-100/90 leading-relaxed">
                                ...
                                <?php if($fleet_utilization < 80): ?>
                                    ...
                                    ?>
                                    This is <span class="text-rose-300 font-bold underline">below optimal levels</span>. You are losing approximately ₱<?php echo e(number_format($lostRevenue)); ?> in daily potential revenue.
                                <?php else: ?>
    ...
    <div id="section-forecast" class="hidden space-y-8">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                    ...
                    <div>
                        ...
                        <div class="flex items-end gap-3 mb-2 relative z-30 w-fit">
                            <span class="text-4xl md:text-5xl font-black text-white leading-none tracking-tight cursor-help border-b-2 border-dashed border-indigo-400/50 pb-1" id="forecast-net-income-trigger" onclick="toggleForecastPopover(event)" onmouseenter="showForecastPopover(event)" onmouseleave="scheduleForecastPopoverHide()">
                                <?php echo e(formatCurrency($forecast_predicted['net_income'] ?? 0)); ?>
                            ...
                            <div id="forecast-computation-popover" class="fixed z-[9999] w-[360px] bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 text-slate-800 opacity-0 invisible transition-all duration-200 pointer-events-none" onmouseenter="cancelForecastPopoverHide()" onmouseleave="scheduleForecastPopoverHide()">
                                ...
                                <div class="space-y-2.5 mb-4">
                                    <div class="flex justify-between items-center p-2.5 bg-emerald-50 rounded-xl border border-emerald-100">
                                        ...
                                        <span class="font-black text-emerald-600 text-sm"><?php echo e(formatCurrency($forecast_predicted['predicted_boundary'] ?? 0)); ?></span>
                                    </div>
                                    <div class="flex justify-between items-center p-2.5 bg-rose-50 rounded-xl border border-rose-100">
                                        ...
                                        <span class="font-black text-rose-600 text-sm"><?php echo e(formatCurrency($forecast_predicted['predicted_expenses'] ?? 0)); ?></span>
                                    </div>
                                    <div class="flex justify-between items-center p-2.5 bg-amber-50 rounded-xl border border-amber-100">
                                        ...
                                        <span class="font-black text-amber-600 text-sm"><?php echo e(formatCurrency($forecast_predicted['predicted_maintenance'] ?? 0)); ?></span>
                                    </div>
                                    <div class="flex justify-between items-center p-2.5 bg-indigo-50 rounded-xl border border-indigo-100">
                                        ...
                                        <span class="font-black text-indigo-600 text-sm"><?php echo e(formatCurrency($forecast_predicted['predicted_salaries'] ?? 0)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="border-t-2 border-dashed border-slate-200 pt-3 mt-3">
                                    ...
                                    <div class="flex justify-between items-center bg-gradient-to-r from-slate-800 to-slate-900 p-4 rounded-xl">
                                        ...
                                        <span class="text-lg font-black <?php echo e(($forecast_predicted['net_income'] ?? 0) >= 0 ? 'text-emerald-400' : 'text-rose-400'); ?>">
                                            <?php echo e(formatCurrency($forecast_predicted['net_income'] ?? 0)); ?>
                                    ...
                                    <div class="mt-3 grid grid-cols-2 gap-2">
                                        <div class="p-2.5 bg-emerald-50 rounded-xl border border-emerald-100 text-center">
                                            ...
                                            <p class="text-sm font-black text-emerald-700"><?php echo e(formatCurrency($forecast_predicted['best_case_net'] ?? 0)); ?></p>
                                        </div>
                                        <div class="p-2.5 bg-amber-50 rounded-xl border border-amber-100 text-center">
                                            ...
                                            <p class="text-sm font-black text-amber-700"><?php echo e(formatCurrency($forecast_predicted['worst_case_net'] ?? 0)); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col">
                                <div class="flex items-center gap-1 px-3 py-1 rounded-full text-xs font-black w-fit
                                    <?php echo e($trendUpNet ? 'bg-emerald-500/20 text-emerald-300' : 'bg-rose-500/20 text-rose-300'); ?>">
                                    <i data-lucide="<?php echo e($trendUpNet ? 'trending-up' : 'trending-down'); ?>" class="w-3.5 h-3.5"></i>
                                    <?php echo e($trendUpNet ? '+' : ''); ?><?php echo e(formatCurrency($diffNet)); ?>
                    ...
                    <div class="flex flex-col sm:flex-row lg:flex-col gap-4 lg:min-w-[260px]">
                        ...
                        <div class="flex-1 p-5 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
                            ...
                            <p class="text-2xl font-black text-emerald-300"><?php echo e(formatCurrency($forecast_predicted['best_case_net'] ?? 0)); ?></p>
                        ...
                        <div class="flex-1 p-5 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10">
                            ...
                            <p class="text-2xl font-black text-amber-300"><?php echo e(formatCurrency($forecast_predicted['worst_case_net'] ?? 0)); ?></p>
                        ...
                        <div class="flex items-center gap-3 p-4 bg-white/5 rounded-2xl border border-white/10">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-black text-white"><?php if(($forecast_predicted['confidence'] ?? '') === 'Mataas' || ($forecast_predicted['confidence'] ?? '') === 'High'): ?> High <?php elseif(($forecast_predicted['confidence'] ?? '') === 'Katamtaman' || ($forecast_predicted['confidence'] ?? '') === 'Medium'): ?> Medium <?php elseif(($forecast_predicted['confidence'] ?? '') === 'Mababa' || ($forecast_predicted['confidence'] ?? '') === 'Low'): ?> Low <?php else: ?> <?php echo e($forecast_predicted['confidence'] ?? 'N/A'); ?> <?php endif; ?></p>
                            </div>
                            <span class="ml-auto px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider
                                ...
                                ?>
                                <?php echo e($conf === 'High' || $conf === 'Mataas' ? 'bg-emerald-500/20 text-emerald-300' : ($conf === 'Medium' || $conf === 'Katamtaman' ? 'bg-amber-500/20 text-amber-300' : 'bg-rose-500/20 text-rose-300')); ?>

                            "><?php if($conf === 'Mataas' || $conf === 'High'): ?> High <?php elseif($conf === 'Katamtaman' || $conf === 'Medium'): ?> Medium <?php elseif($conf === 'Mababa' || $conf === 'Low'): ?> Low <?php else: ?> <?php echo e($conf); ?> <?php endif; ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <?php $__currentLoopData = $forecastCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300 group relative overflow-hidden">
                    ...
                    <div class="absolute -right-6 -top-6 w-28 h-28 bg-<?php echo e($c); ?>-50 rounded-full opacity-60 group-hover:scale-150 transition-transform duration-500"></div>

                    <div class="relative z-10">
                        <div class="flex items-start justify-between mb-4">
                            <div class="p-3 bg-<?php echo e($c); ?>-50 rounded-2xl text-<?php echo e($c); ?>-600 group-hover:scale-110 transition-transform">
                                <i data-lucide="<?php echo e($card['icon']); ?>" class="w-6 h-6"></i>
                            </div>
                            <div class="flex flex-col items-end">
                                <div class="flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-black
                                    <?php echo e($card['key'] === 'boundary' ? ($trendUp ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600') : ($trendUp ? 'bg-rose-50 text-rose-600' : 'bg-emerald-50 text-emerald-600')); ?>">
                                    <i data-lucide="<?php echo e($trendUp ? 'arrow-up-right' : 'arrow-down-right'); ?>" class="w-3 h-3"></i>
                                    <?php echo e($trendUp ? '+' : ''); ?><?php echo e(formatCurrency($trendAmt)); ?>

                                </div>
                            </div>
                        </div>

                        <h3 class="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-1"><?php echo e($card['label']); ?></h3>
                        <p class="text-[9px] font-bold text-slate-400 mb-3 border-b border-slate-100 pb-2">
                            Compute: (<?php echo e(formatCurrency($val)); ?> Expected - <?php echo e(formatCurrency($lastVal)); ?> Last Month)
                        </p>

                        <p class="text-3xl font-black text-slate-800 mb-4"><?php echo e(formatCurrency($val)); ?></p>

                        <div class="pt-4 border-t border-slate-100">
                            <div class="flex items-start gap-2">
                                <i data-lucide="info" class="w-3.5 h-3.5 text-slate-400 flex-shrink-0 mt-0.5"></i>
                                <p class="text-[10px] text-slate-500 leading-relaxed"><?php echo e($card['source']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 flex flex-col items-center justify-center">
                ...
                <div class="relative w-48 h-48 mb-6">
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center">
                        <span class="text-5xl font-black text-slate-800"><?php echo e($healthScore); ?></span>
                        <span class="text-xs font-bold text-slate-400">/ 100</span>
                    </div>
                </div>
                <span class="px-4 py-1.5 rounded-full text-xs font-black <?php echo e($gaugeBg); ?>"><?php echo e($gaugeLabel); ?></span>
                ...
                <div class="space-y-6">
                    ...
                    <div class="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-<?php echo e($revConColor); ?>-50 rounded-xl">
                                    <i data-lucide="bar-chart-3" class="w-5 h-5 text-<?php echo e($revConColor); ?>-600"></i>
                                </div>
                                <div>
                            ...
                            <span class="px-3 py-1 bg-<?php echo e($revConColor); ?>-50 text-<?php echo e($revConColor); ?>-700 rounded-full text-[10px] font-black border border-<?php echo e($revConColor); ?>-200">
                                <?php if($revCon === 'Medyo Pabago-bago'): ?> Moderate Volatility <?php else: ?> <?php echo e($revCon); ?> <?php endif; ?>
                            </span>
                        </div>
                    ...
                    <div class="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-<?php echo e($expColor); ?>-50 rounded-xl">
                                    <i data-lucide="<?php echo e(($expTrend === 'Decreasing' || $expTrend === 'Pababa') ? 'trending-down' : 'trending-up'); ?>" class="w-5 h-5 text-<?php echo e($expColor); ?>-600"></i>
                                </div>
                                <div>
                            ...
                            <span class="px-3 py-1 bg-<?php echo e($expColor); ?>-50 text-<?php echo e($expColor); ?>-700 rounded-full text-[10px] font-black border border-<?php echo e($expColor); ?>-200">
                                <?php if($expTrend === 'Pataas'): ?> Increasing <?php elseif($expTrend === 'Pababa'): ?> Decreasing <?php else: ?> <?php echo e($expTrend); ?> <?php endif; ?>
                            </span>
                        </div>
                    ...
                    <div class="p-5 bg-slate-50 rounded-2xl border border-slate-100">
                        <div class="flex items-center justify-between mb-3">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-<?php echo e($maintColor); ?>-50 rounded-xl">
                                    <i data-lucide="wrench" class="w-5 h-5 text-<?php echo e($maintColor); ?>-600"></i>
                                </div>
                                <div>
                            ...
                            <span class="px-3 py-1 bg-<?php echo e($maintColor); ?>-50 text-<?php echo e($maintColor); ?>-700 rounded-full text-[10px] font-black border border-<?php echo e($maintColor); ?>-200">
                                <?php if($maintTrend === 'Pataas'): ?> Increasing <?php elseif($maintTrend === 'Pababa'): ?> Decreasing <?php else: ?> <?php echo e($maintTrend); ?> <?php endif; ?>
                            </span>
                        </div>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                <?php if(count($forecast_unit_profits) > 0): ?>
                    
                    <?php $topThree = array_slice($forecast_unit_profits, 0, 3); ?>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <?php $__currentLoopData = $topThree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $rank = $idx + 1;
                            $podiumColors = [
                        ...
                        ?>
                        <div class="relative rounded-2xl border-2 <?php echo e($pc['border']); ?> <?php echo e($pc['bg_light']); ?> p-5 overflow-hidden group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                            
                            <div class="absolute -top-3 -right-3 w-14 h-14 bg-gradient-to-br <?php echo e($pc['bg']); ?> rounded-2xl flex items-center justify-center shadow-lg transform rotate-12 group-hover:rotate-0 transition-transform duration-300">
                                <span class="text-2xl"><?php echo e($pc['icon']); ?></span>
                            </div>

                            
                            <div class="mb-4 pr-8">
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Rank #<?php echo e($rank); ?></p>
                                <h4 class="text-2xl font-black text-slate-900 tracking-tight"><?php echo e($unit['plate']); ?></h4>
                            </div>

                            
                            <div class="mb-4">
                                <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Expected Monthly Net Profit</p>
                                <p class="text-xl font-black <?php echo e($monthlyProfit >= 0 ? $pc['text'] : 'text-rose-600'); ?>">
                                    <?php echo e($monthlyProfit >= 0 ? '+' : ''); ?>₱<?php echo e(number_format($monthlyProfit)); ?>
                            ...
                            <div class="grid grid-cols-2 gap-2 pt-3 border-t border-slate-200/50">
                                <div>
                                    ...
                                    <p class="text-xs font-black text-emerald-700">₱<?php echo e(number_format($avgDaily)); ?></p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Daily Profit</p>
                                    <p class="text-xs font-black <?php echo e($dailyProfit >= 0 ? 'text-slate-700' : 'text-rose-600'); ?>"><?php echo e($dailyProfit >= 0 ? '+' : ''); ?>₱<?php echo e(number_format($dailyProfit)); ?></p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Op. Days (90d)</p>
                                    <p class="text-xs font-black text-slate-700"><?php echo e($opDays); ?> days</p>
                                </div>
                                <div>
                                    <p class="text-[9px] font-black text-slate-400 uppercase tracking-widest">Avg Daily Maint.</p>
                                    <p class="text-xs font-black text-rose-600">₱<?php echo e(number_format($avgMaint)); ?></p>
                                </div>
                            </div>

                            
                            <div class="mt-3 p-2 bg-white/60 rounded-xl border border-white text-[9px] text-slate-500 leading-tight">
                                <strong>Formula:</strong> (Avg Daily ₱<?php echo e(number_format($avgDaily)); ?> − Maint ₱<?php echo e(number_format($avgMaint)); ?>) × 30 days
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <?php if(count($forecast_unit_profits) > 3): ?>
                    <div class="bg-slate-50 rounded-2xl border border-slate-100 overflow-hidden">
                        <div class="px-5 py-3 border-b border-slate-100 flex items-center gap-2">
                            ...
                            <h4 class="text-[11px] font-black text-slate-600 uppercase tracking-widest">Ranks 4–<?php echo e(min(10, count($forecast_unit_profits))); ?> — Unit Profitability Breakdown</h4>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm">
                                ...
                                <tbody class="divide-y divide-slate-100">
                                    <?php $__currentLoopData = array_slice($forecast_unit_profits, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $rank = $idx + 4; ?>
                                    <tr class="hover:bg-white transition-colors">
                                        <td class="py-3 px-4 font-black text-slate-400 text-sm">#<?php echo e($rank); ?></td>
                                        <td class="py-3 font-black text-slate-800"><?php echo e($unit['plate']); ?></td>
                                        <td class="py-3 text-right font-semibold text-emerald-700">₱<?php echo e(number_format($unit['avg_daily_boundary'] ?? 0)); ?></td>
                                        <td class="py-3 text-right font-semibold text-rose-500">₱<?php echo e(number_format($unit['avg_daily_maint'] ?? 0)); ?></td>
                                        <td class="py-3 text-right font-black <?php echo e(($unit['daily_profit'] ?? 0) >= 0 ? 'text-emerald-700' : 'text-rose-600'); ?>">
                                            <?php echo e(($unit['daily_profit'] ?? 0) >= 0 ? '+' : ''); ?>₱<?php echo e(number_format($unit['daily_profit'] ?? 0)); ?>

                                        </td>
                                        <td class="py-3 text-right font-black <?php echo e(($unit['monthly_profit'] ?? 0) >= 0 ? 'text-indigo-700' : 'text-rose-600'); ?>">
                                            <?php echo e(($unit['monthly_profit'] ?? 0) >= 0 ? '+' : ''); ?>₱<?php echo e(number_format($unit['monthly_profit'] ?? 0)); ?>

                                        </td>
                                        <td class="py-3 text-right font-semibold text-slate-600 pr-4"><?php echo e($unit['operating_days_90d'] ?? 0); ?>d</td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('analytics.export.csv', ['type' => 'units'])); ?>"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        <?php $__currentLoopData = $unit_roi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="py-3 font-black text-slate-800"><?php echo e($unit['plate']); ?></td>
                            <td class="py-3">
                                <span class="text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider
                                    <?php echo e($unit['status'] === 'active' ? 'bg-emerald-50 text-emerald-700' : ($unit['status'] === 'maintenance' ? 'bg-amber-50 text-amber-700' : 'bg-slate-100 text-slate-500')); ?>">
                                    <?php echo e($unit['status']); ?>

                                </span>
                            </td>
                            <td class="py-3 text-right font-semibold text-emerald-700">₱<?php echo e(number_format($unit['revenue'])); ?></td>
                            <td class="py-3 text-right font-semibold text-rose-600">₱<?php echo e(number_format($unit['maintenance'])); ?></td>
                            <td class="py-3 text-right font-black <?php echo e($unit['net_roi'] >= 0 ? 'text-emerald-700' : 'text-rose-600'); ?>">
                                <?php echo e($unit['net_roi'] >= 0 ? '+' : ''); ?>₱<?php echo e(number_format($unit['net_roi'])); ?>

                            </td>
                            <td class="py-3 text-right font-bold text-slate-700"><?php echo e($unit['roi_pct']); ?>%</td>
                            <td class="py-3 text-center">
                                <span class="text-[10px] font-black px-2.5 py-1 rounded-full uppercase tracking-wider
                                    bg-<?php echo e($unit['rating_color']); ?>-50 text-<?php echo e($unit['rating_color']); ?>-700 border border-<?php echo e($unit['rating_color']); ?>-100">
                                    <?php echo e($unit['rating']); ?>
...
<script>
    ...
    (function initForecastCharts() {
        // Data from PHP
        const fHistory = <?php echo json_encode($forecast_monthly_history ?? [], 15, 512) ?>;
        const fPredicted = <?php echo json_encode($forecast_predicted ?? [], 15, 512) ?>;
        const fHealth = <?php echo json_encode($forecast_health ?? [], 15, 512) ?>;
...
(function() {
    const heatmapData = <?php echo json_encode($heatmap_data, 15, 512) ?>;
...
(function() {
    const utilData = <?php echo json_encode($driver_utilization, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/analytics/index.blade.php ENDPATH**/ ?>