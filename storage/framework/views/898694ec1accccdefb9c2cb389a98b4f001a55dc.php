    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($s->name); ?></td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex text-xs font-bold text-blue-700 bg-blue-50 px-2 py-1 rounded-full"><?php echo e($s->role); ?></span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center gap-1 text-xs font-medium text-red-600 bg-red-50 px-2 py-1 rounded-full">
                        <i data-lucide="clock" class="w-3 h-3"></i>
                        <?php echo e($s->deleted_at->format('M d, Y h:i A')); ?>

                    </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button type="button"
                        onclick="archiveRestore('<?php echo e(route('archive.restore', ['type' => 'staff', 'id' => $s->id])); ?>')"
                    ...
                    <button type="button"
                        onclick="archiveForceDelete('<?php echo e(route('archive.forceDelete', ['type' => 'staff', 'id' => $s->id])); ?>')"
...
<?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/archive/partials/_staff_table.blade.php ENDPATH**/ ?>