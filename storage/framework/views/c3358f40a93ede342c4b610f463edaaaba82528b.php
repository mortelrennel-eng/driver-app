<?php $__env->startSection('title', 'Banned Drivers Roster - Euro System'); ?>
<?php $__env->startSection('page-heading', 'Banned Drivers Roster'); ?>
<?php $__env->startSection('page-subheading', 'Manage drivers under lock-out or administrative suspension'); ?>
...
<div class="space-y-8">
        ...
        <div class="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div class="flex items-center gap-4 shrink-0">
                <div class="flex flex-col text-left md:text-right bg-red-500/5 px-6 py-4 rounded-2xl border border-red-500/10">
                    ...
                    <span id="banned-count-badge" class="text-4xl font-black text-red-500 tracking-tighter"><?php echo e(count($bannedDrivers)); ?></span>
                </div>
    ...
    <div id="bannedDriversGrid" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $bannedDrivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="banned-profile-card bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden flex flex-col cursor-pointer"
                 id="driver-card-<?php echo e($driver->id); ?>"
                 data-status="<?php echo e($driver->driver_status); ?>"
                 data-search-terms="<?php echo e(strtolower($driver->full_name . ' ' . $driver->license_number . ' ' . $driver->contact_number)); ?>"
                ...
                <div class="p-6 border-b border-gray-50 flex items-start gap-4 bg-slate-50/50">
                    <div class="w-14 h-14 bg-gradient-to-br <?php echo e($driver->driver_status === 'suspended' ? 'from-amber-500 to-orange-600 shadow-amber-500/10' : 'from-red-500 to-rose-600 shadow-red-500/10'); ?> rounded-2xl flex items-center justify-center text-white text-lg font-black shrink-0 shadow-lg">
                        <?php echo e(substr($driver->first_name, 0, 1)); ?><?php echo e(substr($driver->last_name, 0, 1)); ?>

                    </div>
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
                            <h4 class="text-base font-black text-slate-900 truncate"><?php echo e($driver->full_name); ?></h4>
                            <?php if($driver->driver_status === 'suspended'): ?>
                        ...
                        <p class="text-[10px] text-slate-400 mt-1 font-bold">REG KEY: DRV-<?php echo e(str_pad($driver->id, 4, '0', STR_PAD_LEFT)); ?></p>
                        <?php if($driver->driver_status === 'suspended'): ?>
                            <?php if(($driver->days_left ?? 0) > 0): ?>
                                <p class="text-[10px] text-amber-600 mt-1 font-black flex items-center gap-1">
                                    ...
                                    SUSPENSION: <?php echo e($driver->days_left); ?> DAYS REMAINING
                                </p>
                            <?php else: ?>
                ...
                <div class="p-6 space-y-4 flex-1">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-0.5">
                            ...
                            <span class="text-xs font-black text-slate-800 font-mono tracking-wider"><?php echo e($driver->license_number ?? 'N/A'); ?></span>
                        </div>
                        <div class="space-y-0.5">
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Contact</span>
                            <span class="text-xs font-black text-slate-800"><?php echo e($driver->contact_number ?? 'N/A'); ?></span>
                        </div>
                        <div class="space-y-0.5">
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Hire Date</span>
                            <span class="text-xs font-bold text-slate-600"><?php echo e($driver->hire_date ? \Carbon\Carbon::parse($driver->hire_date)->format('M d, Y') : 'N/A'); ?></span>
                        </div>
                        <div class="space-y-0.5">
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Registrar</span>
                            <span class="text-xs font-bold text-slate-600 uppercase"><?php echo e($driver->creator_name ?? 'System'); ?></span>
                        </div>
                    </div>

                    <?php if(!empty($driver->suspension_reason)): ?>
                        <div class="pt-3 border-t border-gray-50 space-y-0.5">
                            ...
                            <p class="text-xs font-bold text-slate-700 leading-relaxed italic">"<?php echo e($driver->suspension_reason); ?>"</p>
                        </div>
                    <?php elseif(!empty($driver->address)): ?>
                        <div class="pt-3 border-t border-gray-50 space-y-0.5">
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Address</span>
                            <span class="text-xs font-bold text-slate-600 leading-relaxed block"><?php echo e($driver->address); ?></span>
                        </div>
                    <?php endif; ?>

                    
                    <?php if(count($driver->ban_incidents) > 0): ?>
                        <div class="pt-4 border-t border-gray-50">
                            <h5 class="text-[10px] font-black text-red-500 uppercase tracking-widest mb-2 flex items-center gap-1.5">
                                <i data-lucide="alert-circle" class="w-3.5 h-3.5"></i> Ban Triggers (<?php echo e(count($driver->ban_incidents)); ?> incident(s))
                            </h5>
                            <div class="space-y-2 max-h-32 overflow-y-auto custom-scrollbar">
                                <?php $__currentLoopData = $driver->ban_incidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="p-2.5 bg-red-50/50 rounded-xl border border-red-100/50 flex flex-col gap-1">
                                        <div class="flex justify-between items-center gap-2">
                                            <span class="text-[10px] font-black text-red-800"><?php echo e($inc->incident_type); ?></span>
                                            <span class="text-[8px] font-black uppercase tracking-widest px-1.5 py-0.5 bg-red-200/50 text-red-700 rounded"><?php echo e($inc->severity); ?></span>
                                        </div>
                                        <p class="text-[10px] text-slate-600 leading-relaxed italic break-words">"<?php echo e($inc->description); ?>"</p>
                                        <span class="text-[8px] text-slate-400 font-bold block text-right"><?php echo e(\Carbon\Carbon::parse($inc->incident_date)->format('M d, Y')); ?></span>
                                    </div>
                ...
                <div class="p-5 border-t border-gray-50 bg-slate-50 flex justify-between items-center gap-3 relative z-50" onclick="event.stopPropagation()">
                    ...
                    <button type="button"
                        ...
                        data-name="<?php echo e($driver->full_name); ?>"
                        data-status="<?php echo e($driver->driver_status); ?>">
                        <i data-lucide="shield-alert" class="w-4 h-4 pointer-events-none"></i>
                        <?php echo e($driver->driver_status === 'suspended' ? 'Modify' : 'Re-Suspend'); ?>
        ...
        <form id="addBanSuspendForm" onsubmit="submitAddBanSuspend(event)" class="p-7 space-y-6 overflow-y-auto">
            ...
            <div class="space-y-2">
                ...
                <div class="relative" id="driverSelectContainer">
                    ...
                    <div id="driverDropdown" class="absolute z-50 w-full mt-1 bg-white rounded-xl border border-slate-100 shadow-2xl hidden">
                        <?php $__empty_1 = true; $__currentLoopData = $activeDrivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="driver-search-item px-4 py-3 cursor-pointer flex items-center gap-3"
                                 ...
                                 data-status="<?php echo e($d->driver_status); ?>"
                                 onclick="selectDriver(<?php echo e($d->id); ?>, '<?php echo e(addslashes($d->full_name)); ?>', '<?php echo e($d->driver_status); ?>')">
                                <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-xs font-black shrink-0">
                                    <?php echo e(substr($d->first_name, 0, 1)); ?><?php echo e(substr($d->last_name, 0, 1)); ?>

                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-black text-slate-800 truncate"><?php echo e($d->full_name); ?></p>
                                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest"><?php echo e(ucfirst($d->driver_status)); ?></p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div id="durationSection" class="space-y-2">
                ...
                <div class="flex flex-wrap gap-2 mt-2">
                    <?php $__currentLoopData = [3, 7, 14, 30, 60, 90]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" onclick="document.getElementById('addBanDuration').value = <?php echo e($d); ?>"
        ...
        <form id="changeSuspensionForm" onsubmit="submitChangeSuspension(event)" class="p-7 space-y-5">
            ...
            <div class="space-y-2" id="changeDurationSection">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = [3, 7, 14, 30, 60, 90]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" onclick="document.getElementById('changeSuspendDuration').value = <?php echo e($d); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/driver-management/banned.blade.php ENDPATH**/ ?>