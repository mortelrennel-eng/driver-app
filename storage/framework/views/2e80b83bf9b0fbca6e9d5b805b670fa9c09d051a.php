    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($item->name); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($item->start_year); ?> – <?php echo e($item->end_year); ?></td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <form action="<?php echo e(route('archive.restore', ['type' => 'pricing_rule', 'id' => $item->id])); ?>" method="POST" class="inline-block">
                        <?php echo csrf_field(); ?>
                    ...
                    <button type="button"
                        onclick="archiveForceDelete('<?php echo e(route('archive.forceDelete', ['type' => 'pricing_rule', 'id' => $item->id])); ?>')"
...
<?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/archive/partials/_pricing_rules_table.blade.php ENDPATH**/ ?>