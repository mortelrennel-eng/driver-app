<?php $__env->startSection('title', 'EuroTaxi | Announcement Management'); ?>
<?php $__env->startSection('page-heading', 'Announcements'); ?>
<?php $__env->startSection('page-subheading', 'Manage and broadcast important updates to all drivers'); ?>
                ...
                <div class="card-body p-4 bg-white">
                    <form action="<?php echo e(route('announcements.store')); ?>" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="valid_until" id="valid_until" required min="<?php echo e(date('Y-m-d')); ?>"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all outline-none text-sm font-bold">
            ...
            <div class="card shadow-sm border-0 rounded-2xl overflow-hidden">
                <div class="card-header bg-white py-4 border-b border-gray-50 flex justify-between items-center">
                    ...
                    <span class="text-[10px] font-black text-yellow-700 bg-yellow-50 px-3 py-1 rounded-full border border-yellow-100 uppercase tracking-widest">
                        <?php echo e($announcements->total()); ?> Total
                    </span>
                </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="max-w-md">
                                            <h6 class="text-sm font-black text-gray-900 mb-1 leading-tight"><?php echo e($announcement->title); ?></h6>
                                            <p class="text-xs font-medium text-gray-500 mb-0 leading-relaxed line-clamp-2"><?php echo e($announcement->message); ?></p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 w-44">
                                        <?php if($announcement->valid_until): ?>
                                            <div class="text-[11px] font-bold text-gray-600 uppercase tracking-tighter">
                                                <?php echo e($announcement->valid_until->format('M d, Y')); ?>

                                            </div>
                                            <div class="text-[9px] font-medium <?php echo e($announcement->valid_until->isPast() ? 'text-rose-500' : 'text-emerald-500'); ?>">
                                                <?php echo e($announcement->valid_until->isPast() ? 'Expired' : 'Expires ' . $announcement->valid_until->diffForHumans()); ?>
                                    ...
                                    <td class="px-6 py-4 text-end w-32">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <button 
                                                ...
                                                data-message="<?php echo e($announcement->message); ?>"
                                                data-sent="<?php echo e($announcement->created_at->format('M d, Y')); ?>"
                                                data-until="<?php echo e($announcement->valid_until ? $announcement->valid_until->format('M d, Y') : 'Indefinite'); ?>">
                                            ...
                                            <button 
                                                ...
                                                data-title="<?php echo e($announcement->title); ?>"
                                                data-message="<?php echo e($announcement->message); ?>"
                                                data-until="<?php echo e($announcement->valid_until ? $announcement->valid_until->format('Y-m-d') : ''); ?>">
                                                <i data-lucide="edit-3" class="w-4 h-4"></i>
                                            </button>

                                            <!-- Delete Button -->
                                            <form action="<?php echo e(route('announcements.destroy', $announcement->id)); ?>" method="POST" onsubmit="return confirm('Sigurado ka bang burahin ito?')">
                                                <?php echo csrf_field(); ?>
    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all duration-300 scale-95 opacity-0" id="editModalContainer">
        ...
        <form id="editForm" method="POST">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    <label class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Display Until</label>
                    <input type="date" name="valid_until" id="editValidUntil" required min="<?php echo e(date('Y-m-d')); ?>"
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all outline-none text-sm font-bold">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/announcements/index.blade.php ENDPATH**/ ?>