<div class="overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900"><?php echo e($driver->full_name ?? 'N/A'); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($driver->license_number); ?></td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center gap-1 text-xs font-medium text-red-600 bg-red-50 px-2 py-1 rounded-full">
                        ...
                        <?php echo e($driver->deleted_at->format('M d, Y h:i A')); ?>

                    </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button type="button"
                        onclick="archiveRestore('<?php echo e(route('archive.restore', ['type' => 'driver', 'id' => $driver->id])); ?>')"
                    ...
                    <button type="button"
                        onclick="archiveForceDelete('<?php echo e(route('archive.forceDelete', ['type' => 'driver', 'id' => $driver->id])); ?>')"
...
<?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/archive/partials/_drivers_table.blade.php ENDPATH**/ ?>