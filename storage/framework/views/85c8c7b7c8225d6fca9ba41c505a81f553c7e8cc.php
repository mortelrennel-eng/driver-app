    ...
    <div id="quickStatsBar" class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-700/50 px-6 py-4 flex items-center justify-between gap-4 text-white min-h-[40px]">
        ...
        <div class="flex items-center gap-1 flex-wrap">
            ...
            <div class="flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/20 hover:bg-blue-500/30 transition-all cursor-default select-none">
                ...
                <span id="qs-garage" class="text-[13px] font-black text-blue-400 tabular-nums"><?php echo e($stats['garage'] ?? '—'); ?></span>
            </div>
...
<script>
    ...
    function performSearch(page = 1) {
        ...
        fetch(`<?php echo e(route('units.index')); ?>?search=${encodeURIComponent(query)}&status=${status}&sort=${sort}&page=${page}&view=${currentViewMode}`, {
            headers: {
    ...
    window.showFlaggedUnitsModal = function() {
        ...
        fetch('<?php echo e(route("units.flagged")); ?>')
            .then(res => res.json())
            .then(data => {
                if(data.length === 0) {
                    container.innerHTML = `
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\eurotaxisystem-main\resources\views/units/index.blade.php ENDPATH**/ ?>