<?php $__env->startSection('title', 'Financial Liabilities — Euro Taxi Fleet'); ?>
<?php $__env->startSection('page-heading', 'Financial Liabilities'); ?>
<?php $__env->startSection('page-subheading', 'Track and manage driver accident charges, parts, and boundary shortages'); ?>
...
function fetchPendingDebts() {
    fetch('<?php echo e(route('driver-management.pending-debts')); ?>', {
...
function handlePaymentSubmit(e, form, driverName, debtType, maxBalance, debtId) {
    ...
    Swal.fire({
        ...
        fetch('<?php echo e(route('driver-management.pay-debt')); ?>', {
            method: 'POST',
...
function fetchDebtHistory() {
    fetch('<?php echo e(route('driver-management.debt-history')); ?>', {
        headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }
    })
    .then(r => r.json())
    .then(data => {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/driver-management/pending-debts.blade.php ENDPATH**/ ?>