<?php $__env->startSection('page-heading', 'Owner Control Center'); ?>
<?php $__env->startSection('page-subheading', 'System administration, user management & security audit — Owner only'); ?>
...
<div class="sa-shell p-0">
    ...
    <div style="background: linear-gradient(135deg, #fefce8 0%, #fef3c7 100%); border: 1px solid #fde047; border-radius: 1.5rem; margin: -0.5rem 1.25rem 0 1.25rem; position: relative; z-index: 10;" class="px-6 pt-5 pb-0">
        <div class="flex items-start justify-between mb-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p style="color:#71717a; font-size:.8rem;">Welcome back, <strong style="color:var(--sa-text);"><?php echo e(auth()->user()->full_name); ?></strong> · Full system access</p>
                </div>
            </div>
            <div class="hidden lg:flex items-center gap-3 text-right">

                <div>
                    <p style="color:#16a34a; font-size:1.4rem; font-weight:900;"><?php echo e($activeUsers); ?></p>
                ...
                <div>
                    <p style="color:#000; font-size:1.4rem; font-weight:900;"><?php echo e($totalUsers); ?></p>
        ...
        <div class="sa-tab-bar flex gap-1 overflow-x-auto">
            <button class="sa-tab <?php echo e($tab === 'overview' ? 'active' : ''); ?>" onclick="switchTab('overview')">
                <i data-lucide="layout-dashboard" class="inline w-3.5 h-3.5 mr-1 -mt-0.5"></i>Overview
            </button>
            <button class="sa-tab <?php echo e($tab === 'staff' ? 'active' : ''); ?>" onclick="switchTab('staff')">
                <i data-lucide="user-plus" class="inline w-3.5 h-3.5 mr-1 -mt-0.5"></i>Create Staff
            </button>
            <button class="sa-tab <?php echo e($tab === 'users' ? 'active' : ''); ?>" onclick="switchTab('users')">
                <i data-lucide="users" class="inline w-3.5 h-3.5 mr-1 -mt-0.5"></i>All Users
            </button>
            <button class="sa-tab <?php echo e($tab === 'access' ? 'active' : ''); ?>" onclick="switchTab('access')">
                <i data-lucide="shield-check" class="inline w-3.5 h-3.5 mr-1 -mt-0.5"></i>Page Access
            </button>
            <button class="sa-tab <?php echo e($tab === 'audit' ? 'active' : ''); ?>" onclick="switchTab('audit')">
                <i data-lucide="activity" class="inline w-3.5 h-3.5 mr-1 -mt-0.5"></i>Login History
            </button>
            <button class="sa-tab <?php echo e($tab === 'security' ? 'active' : ''); ?>" onclick="switchTab('security')">
    ...
    <div class="p-6">
        ...
        <div id="tab-overview" class="sa-tab-content <?php echo e($tab === 'overview' ? '' : 'hidden'); ?>">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div class="sa-stat" style="color:#f59e0b;">
                    ...
                    <p style="font-size:2.2rem; font-weight:900; line-height:1; color:#000;"><?php echo e($totalUsers); ?></p>
                ...
                <div class="sa-stat" style="color:#22c55e;">
                    ...
                    <p style="font-size:2.2rem; font-weight:900; line-height:1; color:#000;"><?php echo e($activeUsers); ?></p>
                ...
                <div class="sa-stat" style="color:#ef4444;">
                    ...
                    <p style="font-size:2.2rem; font-weight:900; line-height:1; color:#000;"><?php echo e($rejectedUsers); ?></p>
                ...
                <div style="overflow-x:auto; max-height: 600px; overflow-y: auto;">
                    <table class="sa-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div style="font-weight:700; color:#000;"><?php echo e($audit->user_name ?? 'Unknown'); ?></div>
                                    <div style="font-size:.72rem; color:#64748b;"><?php echo e($audit->user_email ?? ''); ?></div>
                                </td>
                                <td>
                                    <?php
                                        $aMap = [
                                ...
                                <td style="color:#64748b; font-family:monospace; font-size:.78rem;"><?php echo e($audit->ip_address ?? '—'); ?></td>
                                <td style="color:#64748b; font-size:.78rem;" title="<?php echo e($audit->created_at); ?>"><?php echo e(\Carbon\Carbon::parse($audit->created_at)->diffForHumans()); ?></td>
                            </tr>
        ...
        <div id="tab-staff" class="sa-tab-content <?php echo e($tab === 'staff' ? '' : 'hidden'); ?>">
        ...
        <div id="tab-users" class="sa-tab-content <?php echo e($tab === 'users' ? '' : 'hidden'); ?>">
            ...
            <div style="background:var(--sa-card); border:1px solid var(--sa-border); border-radius:1.5rem; overflow:hidden;">
                <div style="overflow-x:auto; max-height: 700px; overflow-y: auto;">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $allUsers->whereNull('deleted_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <tr class="user-row transition-colors" data-name="<?php echo e(strtolower($u->full_name)); ?>" data-email="<?php echo e(strtolower($u->email)); ?>" data-role="<?php echo e(strtolower($u->role)); ?>" data-status="<?php echo e($statusSlug); ?>">
                            <td onclick="openUserDetailsModal(<?php echo e($u->id); ?>)" style="cursor:pointer;">
                                <div class="flex items-center gap-2.5">
                                    <?php if($u->profile_image): ?>
                                        <img src="<?php echo e(asset('storage/' . $u->profile_image)); ?>" style="width:34px;height:34px;border-radius:50%;object-fit:cover;border:2px solid #e5e7eb;" alt="">
                                    <?php else: ?>
                                        <div style="width:34px;height:34px;background:#e2e8f0;border-radius:50%;display:flex;align-items:center;justify-content:center;font-weight:900;font-size:.8rem;color:#64748b;flex-shrink:0;">
                                            <?php echo e(strtoupper(substr($u->full_name ?? 'U', 0, 1))); ?>

                                        </div>
                                    <?php endif; ?>
                                    <div>
                                        <div style="font-weight:700;color:#000;"><?php echo e($u->full_name); ?></div>
                                        <div style="font-size:.7rem;color:#64748b;"><?php echo e($u->email); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td><span class="badge badge-role-<?php echo e($u->role); ?>"><?php echo e($u->role === 'super_admin' ? 'Owner' : ucfirst(str_replace('_', ' ', $u->role))); ?></span></td>
                            <td>
                                <?php if($isActivated): ?>
                            ...
                            <td>
                                <?php if($u->is_disabled): ?>
                                    <button onclick="confirmEnable(<?php echo e($u->id); ?>, '<?php echo e(addslashes($u->full_name)); ?>')" style="background:#fef2f2; border:1px solid #ef4444; color:#b91c1c; border-radius:999px; padding:.2rem .75rem; font-size:.68rem; font-weight:800; cursor:pointer;" title="Click to enable account">
                                        ● Disabled
                                    </button>
                                <?php else: ?>
                                    <button onclick="openDisableModal(<?php echo e($u->id); ?>, '<?php echo e(addslashes($u->full_name)); ?>')" style="background:#f0fdf4; border:1px solid #22c55e; color:#15803d; border-radius:999px; padding:.2rem .75rem; font-size:.68rem; font-weight:800; cursor:pointer;" title="Click to disable account">
                                        ● Active
                                    </button>
                                <?php endif; ?>
                            </td>
                            <td style="color:#64748b; font-size:.78rem;">
                                <?php echo e($u->last_login ? \Carbon\Carbon::parse($u->last_login)->format('M d, Y h:i A') : 'Never'); ?>

                            </td>
                            <td>
                                <div class="flex justify-end gap-1.5">
                                    <button class="p-2 text-slate-400 hover:text-amber-600 transition-colors" title="Edit User" onclick="openEditUserModal(<?php echo e(json_encode($editData)); ?>)">
                                        <i data-lucide="edit-3" class="w-4 h-4"></i>
                                    </button>
                                    <button class="p-2 text-slate-400 hover:text-rose-600 transition-colors" title="Archive User" onclick="archiveUser(<?php echo e($u->id); ?>, '<?php echo e(addslashes($u->full_name)); ?>')">
        ...
        <div id="tab-access" class="sa-tab-content <?php echo e($tab === 'access' ? '' : 'hidden'); ?>">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div style="background:var(--sa-card); border:1px solid var(--sa-border); border-radius:1.5rem; overflow:hidden;">
                    ...
                    <div style="max-height:460px; overflow-y:auto;">
                        <?php $__currentLoopData = $allUsers->where('approval_status', 'approved'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="access-user-item" data-id="<?php echo e($u->id); ?>" data-allowed="<?php echo e(json_encode($u->allowed_pages ?? null)); ?>"
                            ...
                            <div style="flex:1; min-width:0;">
                                <div style="font-weight:700;color:#000;font-size:.82rem; truncate;"><?php echo e($u->full_name); ?></div>
                                <div style="font-size:.68rem;color:#64748b;"><?php echo e($u->role === 'super_admin' ? 'Owner' : ucfirst($u->role)); ?></div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <div class="lg:col-span-2" style="background:var(--sa-card); border:1px solid var(--sa-border); border-radius:1.5rem; overflow:hidden;">
                    ...
                    <div id="page-picker-body" style="padding:1.25rem;">
                        ...
                        <div id="page-chips-container" class="hidden">
                            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $groupPages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mb-4">
                                <p style="font-size:.68rem; font-weight:800; text-transform:uppercase; letter-spacing:.1em; color:#4b5563; margin-bottom:.6rem;"><?php echo e($groupName); ?></p>
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $groupPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $routePattern => $pageDef): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button class="page-chip" data-route="<?php echo e($routePattern); ?>" onclick="togglePageChip(this)">
                                        <i data-lucide="<?php echo e($pageDef['icon']); ?>" class="inline" style="width:10px;height:10px;margin-right:.2rem;"></i>
                                        <?php echo e($pageDef['label']); ?>
        ...
        <div id="tab-audit" class="sa-tab-content <?php echo e($tab === 'audit' ? '' : 'hidden'); ?>">
            ...
            <div style="background:var(--sa-card); border:1px solid var(--sa-border); border-radius:1.5rem; overflow:hidden;">
                <div id="audit-table-container" style="overflow-x:auto; max-height: 700px; overflow-y: auto;">
                    <table class="sa-table">
                        ...
                        <tbody id="audit-tbody">
                            <?php $__currentLoopData = $auditLog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <div style="font-weight:700;color:#000;font-size:.82rem;"><?php echo e($a->user_name ?? 'Unknown'); ?></div>
                                    <div style="font-size:.7rem;color:#64748b;"><?php echo e($a->user_email ?? '—'); ?></div>
                                </td>
                                <td>
                                    <?php if($a->user_role): ?>
                                        <span class="badge badge-role-<?php echo e($a->user_role); ?>"><?php echo e($a->user_role === 'super_admin' ? 'Owner' : ucfirst(str_replace('_',' ',$a->user_role))); ?></span>
                                    <?php else: ?>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($cls2); ?>"><?php echo e($lbl2); ?></span>
                                </td>
                                <td style="color:#64748b;font-family:monospace;font-size:.76rem;"><?php echo e($a->ip_address ?? '—'); ?></td>
                                <td style="color:#64748b;font-size:.72rem;max-width:160px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?php echo e($a->user_agent); ?>">
                                    <?php echo e(Str::limit($a->user_agent ?? '—', 45)); ?>

                                </td>
                                <td style="color:#64748b;font-size:.75rem;"><?php echo e($a->notes ?? '—'); ?></td>
                                <td style="color:#64748b;font-size:.75rem;white-space:nowrap;"><?php echo e(\Carbon\Carbon::parse($a->created_at)->format('M d, Y h:i A')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                ...
                <div class="flex items-center justify-between px-4 py-3 border-t border-sa-border" style="border-color:var(--sa-border);">
                    <span id="audit-info" style="font-size:.75rem; color:#64748b;">Showing <?php echo e($auditLog->firstItem() ?? 0); ?> – <?php echo e($auditLog->lastItem() ?? 0); ?> of <?php echo e($auditLog->total()); ?></span>
                    <div class="flex gap-2" id="audit-pagination">
                        <?php if($auditLog->onFirstPage()): ?>
                            <button class="btn-ghost" disabled style="opacity:.4; cursor:not-allowed;">← Prev</button>
                        <?php else: ?>
                            <button class="btn-ghost" onclick="loadAuditLog(<?php echo e($auditLog->currentPage() - 1); ?>)">← Prev</button>
                        <?php endif; ?>
                        <?php if($auditLog->hasMorePages()): ?>
                            <button class="btn-ghost" onclick="loadAuditLog(<?php echo e($auditLog->currentPage() + 1); ?>)">Next →</button>
                        <?php else: ?>
        ...
        <div id="tab-security" class="sa-tab-content <?php echo e($tab === 'security' ? '' : 'hidden'); ?>">
        ...
        <div style="padding: 1.5rem; overflow-y: auto; flex: 1; background: #fff;">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div class="flex items-center gap-2">
                                                <h5 class="text-sm font-black text-slate-900"><?php echo e($r->label); ?></h5>
                                                <span class="text-[9px] font-black uppercase tracking-widest text-slate-400 bg-slate-50 px-1.5 py-0.5 rounded border border-slate-100"><?php echo e($r->name); ?></span>
                                            </div>
                                            <p class="text-[10px] text-slate-500 mt-0.5"><?php echo e($r->description ?? 'No description provided.'); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button class="p-2 hover:text-amber-600 transition-colors" title="Edit Role" onclick="editRole(<?php echo e(json_encode($r)); ?>)">
                                            <i data-lucide="edit-3" class="w-4 h-4"></i>
                                        </button>
                                        <button class="p-2 hover:text-rose-600 transition-colors" title="Archive Role" onclick="archiveRole(<?php echo e($r->id); ?>)">
                                            <i data-lucide="archive" class="w-4 h-4"></i>
                                        </button>
                                    </div>
                                </div>
                ...
                <div style="background:var(--sa-card); border:1px solid var(--sa-border); border-radius:1.5rem; overflow:hidden; opacity: 0.8;">
                    ...
                    <div style="padding:1rem;">
                        <?php if($archivedRoles->count() > 0): ?>
                            <div class="space-y-3">
                                <?php $__currentLoopData = $archivedRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="group border border-slate-100 rounded-xl p-4 bg-slate-50/50 grayscale">
                                    <div class="flex items-start justify-between">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h5 class="text-sm font-bold text-slate-600"><?php echo e($r->label); ?></h5>
                                                <p class="text-[10px] text-slate-400 mt-0.5"><?php echo e($r->name); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-1">
                                            <button class="p-2 hover:text-emerald-600 transition-colors" title="Restore Role" onclick="restoreRole(<?php echo e($r->id); ?>)">
                                                <i data-lucide="rotate-ccw" class="w-4 h-4"></i>
                                            </button>
                                            <button class="p-2 hover:text-rose-600 transition-colors" title="Delete Permanently" onclick="deleteRole(<?php echo e($r->id); ?>)">
    ...
    <div class="sa-modal" style="max-width: 800px; padding: 0; overflow: hidden; display: flex; flex-direction: column; max-height: 85vh;">
        ...
        <div style="padding: 1rem; overflow-y: auto; flex: 1; background: #fff;">
            <table class="sa-table">
                ...
                <tbody>
                    <?php $archivedCount = 0; ?>
                    <?php $__currentLoopData = $allUsers->whereNotNull('deleted_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $archivedCount++; ?>
                        <tr>
                            <td>
                                <div style="font-weight:700;color:#000;"><?php echo e($u->full_name); ?></div>
                            ...
                            <td><span class="badge badge-role-<?php echo e($u->role); ?>"><?php echo e($u->role === 'super_admin' ? 'Owner' : ucfirst(str_replace('_', ' ', $u->role))); ?></span></td>
                            <td style="color:#64748b; font-size:.75rem;"><?php echo e($u->deleted_at->format('M d, Y h:i A')); ?></td>
                            <td style="text-align:right;">
                                <div class="flex gap-2 justify-end">
                                    <button class="btn-approve px-4 py-1.5" onclick="restoreUser(<?php echo e($u->id); ?>, '<?php echo e($u->full_name); ?>')">
                                        <i data-lucide="rotate-ccw" class="inline w-3 h-3 mr-1"></i> Restore
                                    </button>
                                    <button class="btn-reject px-4 py-1.5" onclick="deleteUserPermanently(<?php echo e($u->id); ?>, '<?php echo e($u->full_name); ?>')">
...
async function submitClassification(e) {
 ...
 async function deleteClassification(id) {
  ...
  async function updateArchivePassword(e) {
      ...
      try {
          const res = await fetch('<?php echo e(route("super-admin.security.update-archive-password")); ?>', {
              method: 'POST',
              headers: { 'X-CSRF-TOKEN': CSRF, 'Content-Type': 'application/json', 'Accept': 'application/json' },
...
async function submitStaff(e) {
    ...
    try {
        ...
        const res = await fetch('<?php echo e(route('super-admin.store-staff')); ?>', {
            method: 'POST',
            headers: { 'X-CSRF-TOKEN': CSRF, 'Content-Type': 'application/json', 'Accept': 'application/json' },
            body: JSON.stringify(payload)
        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/super-admin/index.blade.php ENDPATH**/ ?>