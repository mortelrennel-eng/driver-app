    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">Unit #<?php echo e($b->unit_id); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-green-700"><?php echo e(formatCurrency($b->boundary_amount)); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($b->date); ?></td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center gap-1 text-xs font-medium text-red-600 bg-red-50 px-2 py-1 rounded-full">
                        ...
                        <?php echo e($b->deleted_at->format('M d, Y h:i A')); ?>

                    </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <form action="<?php echo e(route('archive.restore', ['type' => 'boundary', 'id' => $b->id])); ?>" method="POST" class="inline-block">
                        <?php echo csrf_field(); ?>
                    ...
                    <button type="button"
                        onclick="archiveForceDelete('<?php echo e(route('archive.forceDelete', ['type' => 'boundary', 'id' => $b->id])); ?>')"
...
<?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/archive/partials/_boundaries_table.blade.php ENDPATH**/ ?>