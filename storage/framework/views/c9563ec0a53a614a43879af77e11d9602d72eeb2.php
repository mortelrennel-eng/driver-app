...
<?php $__env->startSection('main-padding', 'p-0'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white px-4 lg:px-6 py-4 border-b border-gray-200">
        <form method="GET" action="<?php echo e(route('units.index')); ?>" class="flex flex-col lg:flex-row gap-2 items-center justify-between w-full">
            ...
            <div class="grid grid-cols-2 lg:contents gap-2 w-full">
                ...
                <div class="col-span-1 lg:w-36 order-2 lg:order-1 flex-shrink-0">
                    <div class="relative">
                        ...
                        <select name="sort" onchange="this.form.submit()"
                            ...
                            <option value="alphabetical" <?php echo e(($sort ?? '') === 'alphabetical' ? 'selected' : ''); ?>>A-Z (Plate #)</option>
                            <option value="newest" <?php echo e(($sort ?? '') === 'newest' ? 'selected' : ''); ?>>Newest Added</option>
                            <option value="oldest" <?php echo e(($sort ?? '') === 'oldest' ? 'selected' : ''); ?>>Oldest Added</option>
                            <option value="vacant" <?php echo e(($sort ?? '') === 'vacant' ? 'selected' : ''); ?>>Vacant Units First</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-span-1 lg:w-36 order-3 flex-shrink-0">
                    <select name="status" onchange="this.form.submit()"
                        ...
                        <option value="active" <?php echo e($status_filter === 'active' ? 'selected' : ''); ?>>Active Units</option>
                        <option value="available" <?php echo e($status_filter === 'available' ? 'selected' : ''); ?>>Available (No Driver)</option>
                        <option value="1_2" <?php echo e($status_filter === '1_2' ? 'selected' : ''); ?>>1/2 Driver (Solo)</option>
                        <option value="2_2" <?php echo e($status_filter === '2_2' ? 'selected' : ''); ?>>2/2 Driver (Shared)</option>
                        <option value="maintenance" <?php echo e($status_filter === 'maintenance' ? 'selected' : ''); ?>>In Maintenance</option>
                        <option value="coding" <?php echo e($status_filter === 'coding' ? 'selected' : ''); ?>>In Coding</option>
            ...
            <div id="unitActionButtonsBar" class="flex gap-1.5 lg:gap-2 items-center flex-nowrap overflow-x-auto whitespace-nowrap scrollbar-none w-full lg:w-auto lg:flex-shrink-0 max-w-full pb-1 mt-2 lg:mt-0 order-4" style="-ms-overflow-style: none; scrollbar-width: none;">
                ...
                <button type="button" onclick="window.open('<?php echo e(route('units.print')); ?>', '_blank')"
    ...
    <div id="quickStatsBar" class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border-b border-gray-700/50 px-3 md:px-6 py-2.5 md:py-4 flex items-center justify-between gap-4 text-white min-h-[40px]">
        ...
        <div class="flex items-center gap-1 md:gap-1.5 flex-nowrap overflow-x-auto whitespace-nowrap scrollbar-none max-w-full" style="-ms-overflow-style: none; scrollbar-width: none;">
            ...
            <div class="flex items-center gap-2 px-2.5 md:px-3 py-1 rounded-full bg-white/10 hover:bg-white/20 transition-all cursor-default select-none flex-shrink-0">
                ...
                <span id="qs-total" class="text-[13px] font-black text-white tabular-nums"><?php echo e($stats['total'] ?? '—'); ?></span>
            </div>
            ...
            <div class="flex items-center gap-2 px-2.5 md:px-3 py-1 rounded-full bg-green-500/20 hover:bg-green-500/30 transition-all cursor-default select-none flex-shrink-0">
                ...
                <span id="qs-onroad" class="text-[13px] font-black text-green-400 tabular-nums"><?php echo e($stats['on_road'] ?? '—'); ?></span>
            </div>
            ...
            <div class="flex items-center gap-2 px-2.5 md:px-3 py-1 rounded-full bg-yellow-500/20 hover:bg-yellow-500/30 transition-all cursor-default select-none flex-shrink-0">
                ...
                <span id="qs-workshop" class="text-[13px] font-black text-yellow-400 tabular-nums"><?php echo e($stats['workshop'] ?? '—'); ?></span>
            </div>
            ...
            <div class="flex items-center gap-2 px-2.5 md:px-3 py-1 rounded-full bg-red-500/20 hover:bg-red-500/30 transition-all cursor-default select-none flex-shrink-0">
                ...
                <span id="qs-coding" class="text-[13px] font-black text-red-400 tabular-nums"><?php echo e($stats['coding'] ?? '—'); ?></span>
            </div>
        </div>
    ...
    <div id="unitsTableContainer" class="bg-white overflow-hidden">
        <?php if(($view_mode ?? 'table') === 'grid'): ?>
            <?php echo $__env->make('units.partials._units_grid', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php else: ?>
            <?php echo $__env->make('units.partials._units_table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    </div>
    ...
    <div id="addUnitModal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl h-[90vh] flex flex-col overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('units.store')); ?>" id="addUnitForm" class="flex flex-col flex-1 overflow-hidden">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="relative">
                                ...
                                <select id="add_driver1" name="driver_id" class="hidden">
                                    ...
                                    <?php $__currentLoopData = $all_drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($driver->id); ?>" data-name="<?php echo e($driver->full_name); ?>" data-license="<?php echo e($driver->license_number ?? ''); ?>" data-assigned-unit="<?php echo e($driver->assigned_unit_id); ?>">
                            ...
                            <div class="relative">
                                ...
                                <select id="edit_driver1" name="driver_id" class="hidden">
                                    ...
                                    <?php $__currentLoopData = $all_drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($d->id); ?>" data-name="<?php echo e($d->full_name); ?>" data-license="<?php echo e($d->license_number ?? ''); ?>" data-assigned-unit="<?php echo e($d->assigned_unit_id); ?>">
...
<?php echo $__env->make('units.partials._unit_details_shared', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    // ── Quick Stats ─────────────────────────────────────────────────
    var QUICK_STATS_URL = '<?php echo e(route("units.quick-stats")); ?>';
    ...
    function performSearch(page = 1) {
        ...
        const finalUrl = `<?php echo e(route('units.index')); ?>?search=${encodeURIComponent(query)}&status=${status}&sort=${sort}&page=${page}&view=${currentViewMode}`;
    ...
    <!-- Leaflet JS for Map -->
    <script src="<?php echo e(asset('assets/leaflet/leaflet.js')); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/units/index.blade.php ENDPATH**/ ?>