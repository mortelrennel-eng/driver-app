    ...
    <div id="unitExplorerPanel">
        ...
        <div class="px-4 py-3 border-b bg-gray-50/70 flex flex-col gap-2.5 flex-shrink-0">
            <div class="flex justify-between items-center">
                ...
                <span class="text-[9px] font-black uppercase tracking-widest text-gray-400">
                    <?php echo e(count($tracked_units)); ?> units
                </span>
            </div>
        ...
        <div class="unit-scroll" id="unitList">
            <?php $__empty_1 = true; $__currentLoopData = $tracked_units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="unit-item p-2.5 border-b border-gray-100 <?php echo e($unit->gps_status === 'offline' ? 'opacity-70' : ''); ?>"
                    data-unit-id="<?php echo e($unit->id); ?>"
                    data-plate-number="<?php echo e($unit->plate_number); ?>"
                    data-driver-name="<?php echo e($unit->driver_name ?? ''); ?>"
                    data-secondary-driver="<?php echo e($unit->secondary_driver ?? ''); ?>"
                    ...
                    <div class="flex justify-between items-center mb-1.5">
                        ...
                        <div class="status-badge" id="status-unit-<?php echo e($unit->id); ?>">
                            <?php
                            ...
                            ?>
                            <span class="px-1.5 py-0.5 text-[8.5px] font-black uppercase tracking-tighter rounded-sm border <?php echo e($sc); ?>">
                                <?php echo e(ucfirst($unit->gps_status)); ?>
                    ...
                    <div class="driver-reveal flex flex-col gap-1.5 border-t border-gray-50 pt-1">
                        <div class="flex items-center gap-1.5 min-w-0">
                            ...
                            <span class="driver-primary text-[11px] font-bold text-gray-700 leading-none truncate"><?php echo e($unit->driver_name ?: 'None'); ?></span>
                        </div>
                        <div class="secondary-driver-container flex items-center gap-1.5 min-w-0 <?php echo e(!$unit->secondary_driver ? 'hidden' : ''); ?>">
                            ...
                            <span class="driver-secondary text-[11px] font-bold text-gray-500 leading-none truncate"><?php echo e($unit->secondary_driver); ?></span>
                        </div>
                    </div>

                    <div class="flex justify-between items-center text-[10px] font-bold text-gray-400 uppercase tracking-tighter">
                        <div class="flex items-center gap-1" id="engine-status-container-<?php echo e($unit->id); ?>">
                            <i data-lucide="zap" class="w-3 h-3 <?php echo e($unit->ignition_status ? 'text-green-500' : 'text-gray-300'); ?>"></i>
                            <span><?php echo e($unit->ignition_status ? 'Engine ON' : 'Engine OFF'); ?></span>
                        </div>
                        <div class="flex items-baseline gap-0.5">
                            <span class="text-[13px] font-black text-gray-800 unit-speed"><?php echo e(number_format($unit->speed ?? 0, 1)); ?></span>
            ...
            <div class="flex items-center gap-2 ml-auto flex-shrink-0">
                <div class="flex items-center divide-x divide-gray-200 border border-gray-200 rounded-lg bg-white overflow-hidden shadow-sm text-center">
                    <div class="flex flex-row px-2 py-1 items-center gap-1">
                        ...
                        <span id="stat-total" class="text-xs font-black text-gray-900"><?php echo e($stats['total'] ?? 0); ?></span>
                    </div>
                    <div class="flex flex-row px-2 py-1 items-center gap-1 bg-green-50/40">
                        ...
                        <span id="stat-active" class="text-xs font-black text-green-600"><?php echo e($stats['moving'] ?? 0); ?></span>
                    </div>
                    <div class="flex flex-row px-2 py-1 items-center gap-1 bg-yellow-50/40">
                        ...
                        <span id="stat-idle" class="text-xs font-black text-yellow-600"><?php echo e($stats['idle'] ?? 0); ?></span>
                    </div>
                    <div class="flex flex-row px-2 py-1 items-center gap-1 bg-blue-50/40">
                        ...
                        <span id="stat-stopped" class="text-xs font-black text-blue-600"><?php echo e($stats['stopped'] ?? 0); ?></span>
                    </div>
                    <div class="flex flex-row px-2 py-1 items-center gap-1 bg-gray-50">
                        ...
                        <span id="stat-offline" class="text-xs font-black text-gray-500"><?php echo e($stats['offline'] ?? 0); ?></span>
                    </div>
                </div>
...
<script src="<?php echo e(asset('js/realtime-tracking.js')); ?>?v=<?php echo e(time()); ?>"></script>
<script>
/* ================================================================
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/live-tracking/index.blade.php ENDPATH**/ ?>