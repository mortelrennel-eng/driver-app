...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        window.__INITIAL_STATS__ = <?php echo json_encode($stats, 15, 512) ?>;
    </script>
        ...
        <div onclick="showUnitsModal()" class="card-hover cursor-pointer group relative overflow-hidden rounded-2xl shadow-sm border border-blue-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-blue-50 to-indigo-50/70">
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-900 text-xl sm:text-3xl font-black leading-none mb-1" data-stat="active_units"><?php echo e($stats['active_units']); ?></p>
                    <p class="text-blue-400 text-[10px] sm:text-xs font-medium"><span class="text-emerald-600 font-bold" data-stat="roi_achieved"><?php echo e($stats['roi_units']); ?></span> ROI Achieved</p>
                </div>
            ...
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-col">
                        <span class="text-gray-900 text-lg sm:text-2xl font-black leading-none mb-0.5" data-stat="today_boundary"><?php echo e(formatCurrency($stats['today_boundary'])); ?></span>
                    ...
                    <div class="mt-2 pt-2 sm:mt-3 sm:pt-3 border-t border-emerald-100/50">
                        <p class="text-gray-900 text-base sm:text-lg font-black leading-none mb-0.5" data-stat="month_boundary"><?php echo e(formatCurrency($stats['month_boundary'] ?? 0)); ?></p>
        ...
        <div onclick="showNetIncomeModal()" class="card-hover cursor-pointer group relative overflow-hidden rounded-2xl shadow-sm border border-green-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-green-50 to-lime-50/70">
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-col">
                        <span class="text-gray-900 text-lg sm:text-2xl font-black leading-none mb-0.5" data-stat="net_income"><?php echo e(formatCurrency($stats['net_income'])); ?></span>
                    ...
                    <div class="mt-2 pt-2 sm:mt-3 sm:pt-3 border-t border-green-100/50">
                        <p class="text-gray-900 text-base sm:text-lg font-black leading-none mb-0.5" data-stat="net_income_month"><?php echo e(formatCurrency($stats['net_income_month'] ?? 0)); ?></p>
        ...
        <div onclick="showMaintenanceUnitsModal()" class="card-hover cursor-pointer group relative overflow-hidden rounded-2xl shadow-sm border border-orange-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-orange-50 to-amber-50/70">
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-900 text-xl sm:text-3xl font-black leading-none mb-1" data-stat="maintenance_units"><?php echo e($stats['maintenance_units']); ?></p>
        ...
        <div onclick="showActiveDriversModal()" class="card-hover cursor-pointer group relative overflow-hidden rounded-2xl shadow-sm border border-indigo-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-indigo-50 to-violet-50/70">
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-900 text-xl sm:text-3xl font-black leading-none" data-stat="active_drivers"><?php echo e($stats['active_drivers']); ?></p>
                </div>
        ...
        <div onclick="showExpensesModal()" class="card-hover cursor-pointer group relative overflow-hidden rounded-2xl shadow-sm border border-rose-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-rose-50 to-red-50/70">
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-900 text-lg sm:text-2xl font-black leading-none" data-stat="today_expenses"><?php echo e(formatCurrency($stats['total_expenses_today'])); ?></p>
                </div>
        ...
        <div onclick="showCodingUnitsModal()" class="col-span-2 lg:col-span-1 card-hover cursor-pointer group relative overflow-hidden rounded-2xl shadow-sm border border-violet-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl bg-gradient-to-br from-violet-50 to-purple-50/70">
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-gray-900 text-xl sm:text-3xl font-black leading-none mb-1" data-stat="coding_units"><?php echo e($stats['coding_units']); ?></p>
                    <p class="text-violet-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-tight"><?php echo e(now()->timezone('Asia/Manila')->format('l')); ?></p>
                </div>
                ...
                <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-xl p-6 shadow-sm relative" id="incomeReport">
                    ...
                    <div class="text-center mb-10 print-only">
                        <div class="flex flex-col items-center mb-4">
                            <img src="<?php echo e(asset('image/logo.png')); ?>" alt="Euro Taxi Logo" class="h-16 w-auto mb-2">
                        </div>
        ...
        <div class="flex-1 overflow-hidden flex flex-col min-h-0">
            ...
            <div class="bg-gray-50 p-4 border-b border-gray-200 flex-shrink-0 print-section overflow-y-auto max-h-[85vh]">
                <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-xl p-6 shadow-sm relative" id="expensesReport">
                    ...
                    <div class="text-center mb-10 print-only">
                        <div class="flex flex-col items-center mb-4">
                            <img src="<?php echo e(asset('image/logo.png')); ?>" alt="Euro Taxi Logo" class="h-16 w-auto mb-2" style="height:64px; width:auto;">
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>