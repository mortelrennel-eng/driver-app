        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-bold text-gray-900"><?php echo e($u->full_name); ?></div>
                    <?php if($u->role === 'driver' && $u->driver): ?>
                        <div class="text-[10px] text-indigo-600 font-semibold italic">Linked to Driver: <?php echo e($u->driver->full_name); ?></div>
                    <?php endif; ?>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex text-[10px] font-bold text-blue-700 bg-blue-50 px-2 py-0.5 rounded-full uppercase tracking-tight"><?php echo e($u->role); ?></span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-xs font-medium text-gray-600"><?php echo e($u->email); ?></div>
                    <div class="text-[10px] text-gray-400"><?php echo e($u->phone_number); ?></div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                    <span class="inline-flex items-center gap-1 text-xs font-medium text-red-600 bg-red-50 px-2 py-1 rounded-full">
                        <i data-lucide="clock" class="w-3 h-3"></i>
                        <?php echo e($u->deleted_at->format('M d, Y h:i A')); ?>

                    </span>
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <button type="button"
                        onclick="archiveRestore('<?php echo e(route('archive.restore', ['type' => 'user', 'id' => $u->id])); ?>')"
                    ...
                    <button type="button"
                        onclick="archiveForceDelete('<?php echo e(route('archive.forceDelete', ['type' => 'user', 'id' => $u->id])); ?>')"
...
<?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/archive/partials/_user_accounts_table.blade.php ENDPATH**/ ?>