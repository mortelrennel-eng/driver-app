<?php $__env->startSection('title', 'Driver Terms & Conditions - Euro System'); ?>
<?php $__env->startSection('page-heading', 'Driver Terms & Conditions'); ?>
<?php $__env->startSection('page-subheading', 'Official company policies and contractual terms for drivers'); ?>
...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $termsImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group">
                <div class="p-4 border-b border-gray-50 bg-gray-50/50 flex justify-between items-center">
                    <h3 class="font-bold text-gray-800 flex items-center gap-2">
                        ...
                        Document Page <?php echo e($index + 1); ?>

                    </h3>
                    <form action="<?php echo e(route('driver-management.terms.delete', $image)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this document?');">
                        <?php echo csrf_field(); ?>
                ...
                <div class="p-6 flex justify-center items-center bg-gray-50 min-h-[500px] relative">
                    <img src="<?php echo e(asset('uploads/terms/' . $image)); ?>" alt="Terms Page <?php echo e($index + 1); ?>" 
                         ...
                         onclick="openLightbox('<?php echo e(asset('uploads/terms/' . $image)); ?>')">
                </div>
            </div>
            ...
            <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div class="mt-2">
                        ...
                        <form action="<?php echo e(route('driver-management.terms.upload')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/driver-management/terms.blade.php ENDPATH**/ ?>