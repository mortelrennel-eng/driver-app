...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo e(asset('assets/app.css')); ?>?v=1.8" rel="stylesheet">
    <?php echo $__env->yieldPushContent('styles'); ?>

    <!-- Custom JS -->
    <script src="<?php echo e(asset('assets/app.js')); ?>?v=1.8"></script>
                ...
                <div class="h-full flex flex-col w-full">
                    ...
                    <nav class="flex-1 p-2 lg:p-4 space-y-1 overflow-y-auto overflow-x-hidden w-full">
                        ...
                        <div class="relative group w-full">
                            ...
                            <div class="hidden group-hover:block lg:pl-10 pl-0 space-y-1 mt-1 transition-all duration-300">
                                <a href="<?php echo e(route('driver-management.banned')); ?>" class="<?php echo e(request()->routeIs('driver-management.banned') ? 'text-red-500 font-bold bg-red-50/50 block rounded-xl py-2 px-3' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50 block rounded-xl py-2 px-3'); ?> flex items-center gap-2">
                                    <i data-lucide="ban" class="w-3.5 h-3.5 <?php echo e(request()->routeIs('driver-management.banned') ? 'text-red-500' : 'text-slate-400'); ?>"></i> 
                                    <span class="text-[10px] uppercase tracking-wider font-bold">Banned Drivers</span>
                                </a>
                                <a href="<?php echo e(route('driver-management.terms')); ?>" class="<?php echo e(request()->routeIs('driver-management.terms') ? 'text-blue-600 font-bold bg-blue-50/50 block rounded-xl py-2 px-3' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50 block rounded-xl py-2 px-3'); ?> flex items-center gap-2">
                                    <i data-lucide="file-signature" class="w-3.5 h-3.5 <?php echo e(request()->routeIs('driver-management.terms') ? 'text-blue-600' : 'text-slate-400'); ?>"></i> 
                                    <span class="text-[10px] uppercase tracking-wider font-bold">Driver Terms</span>
                                </a>
                                <a href="<?php echo e(route('driver-management.debts')); ?>" class="<?php echo e(request()->routeIs('driver-management.debts') ? 'text-rose-600 font-bold bg-rose-50/50 block rounded-xl py-2 px-3' : 'text-slate-500 hover:text-slate-800 hover:bg-slate-50 block rounded-xl py-2 px-3'); ?> flex items-center gap-2">
                                    <i data-lucide="wallet" class="w-3.5 h-3.5 <?php echo e(request()->routeIs('driver-management.debts') ? 'text-rose-600' : 'text-slate-400'); ?>"></i> 
                        ...
                        <?php if(auth()->user()->hasAccessTo('support.*')): ?>
                        <a href="<?php echo e(route('support.index')); ?>"
                            class="sidebar-item flex items-center justify-start md:justify-center lg:justify-start gap-2.5 px-4 md:px-0 lg:px-4 py-1.5 md:py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 <?php echo e(request()->routeIs('support.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : ''); ?>">
                        ...
                        <?php if(auth()->user()->hasAccessTo('announcements.*')): ?>
                        <a href="<?php echo e(route('announcements.index')); ?>"
                            class="sidebar-item flex items-center justify-start md:justify-center lg:justify-start gap-2.5 px-4 md:px-0 lg:px-4 py-1.5 md:py-2 rounded-lg text-gray-700 hover:bg-yellow-50 hover:text-yellow-700 <?php echo e(request()->routeIs('announcements.*') ? 'bg-yellow-50 text-yellow-700 font-semibold' : ''); ?>">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.LaravelUserId = "<?php echo e(Auth::id()); ?>";
    ...
    <script>
        ...
        (function() {
            const isSupportPage = <?php echo json_encode(request()->routeIs('support.*'), 15, 512) ?>;
    ...
    <?php echo $__env->make('partials.chat-drawer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div id="globalSosAlert" class="fixed inset-0 z-[100000] hidden items-center justify-center bg-red-900/90 backdrop-blur-sm">
        <div class="bg-white border-4 border-red-600 rounded-2xl shadow-2xl p-6 md:p-10 w-11/12 max-w-2xl text-center animate-bounce-in relative overflow-hidden">
            ...
            <h1 class="text-3xl md:text-5xl font-black text-red-600 mb-2 tracking-tight uppercase">SOS Emergency!</h1>
...
</html><?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>