    ...
    <table class="min-w-full text-sm modern-table-sep">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr class="<?php echo e($has_maintenance_data ? 'modern-row-has-sub' : 'modern-row'); ?> cursor-pointer group" onclick="viewUnitDetails(<?php echo e($unit->id); ?>)">
                    
                    <td class="px-2 md:px-6 py-3 md:py-5 whitespace-nowrap">
                        <div class="flex flex-col">
                            <span class="text-xs md:text-sm font-black text-gray-900 tracking-tight"><?php echo e($unit->plate_number); ?></span>
                            <div class="mt-1 flex flex-col gap-0.5">
                                <span class="text-[8px] md:text-[9px] font-bold text-gray-400 uppercase tracking-tighter">M: <?php echo e($unit->motor_no ?? '—'); ?></span>
                                <span class="text-[8px] md:text-[9px] font-bold text-gray-400 uppercase tracking-tighter">C: <?php echo e($unit->chassis_no ?? '—'); ?></span>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="px-2 md:px-6 py-3 md:py-5 whitespace-nowrap">
                        <div class="flex flex-col">
                            <span class="text-xs md:text-sm font-black text-gray-900"><?php echo e($unit->make); ?> <?php echo e($unit->model); ?></span>
                            <span class="text-[10px] md:text-xs font-bold text-gray-400"><?php echo e($unit->year); ?></span>
                            <div class="mt-1.5">
                    ...
                    <td class="px-2 md:px-6 py-3 md:py-5 whitespace-nowrap">
                        <div class="flex items-center gap-1.5 md:gap-2">
                            <div class="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full <?php echo e($dotClass); ?> animate-pulse <?php echo e($unit->status === 'active' ? 'shadow-[0_0_8px_rgba(34,197,94,0.5)]' : ''); ?>"></div>
                            <span class="text-[9px] md:text-[11px] font-black uppercase tracking-wider md:tracking-widest <?php echo e($statusColor); ?>">
                    ...
                    <td class="px-2 md:px-6 py-3 md:py-5 whitespace-nowrap">
                        <div class="flex flex-col">
                            <span class="text-xs md:text-sm font-black text-gray-900">₱<?php echo e(number_format($unit->current_rate ?? $unit->boundary_rate, 2)); ?></span>
                            <div class="mt-1.5">
                ...
                <?php if($has_maintenance_data): ?>
                    <tr class="modern-sub-row cursor-pointer" onclick="viewUnitDetails(<?php echo e($unit->id); ?>)">
...
<?php /**PATH /home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/units/partials/_units_table.blade.php ENDPATH**/ ?>