...
fs.writeFileSync('test_kill2.php', phpCode);

const conn = new Client();
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        if (err) throw err;
        sftp.fastPut('test_kill2.php', '/home/u747826271/domains/eurotaxisystem.site/public_html/test_kill2.php', (err) => {
            if (err) throw err;
            conn.exec('php /home/u747826271/domains/eurotaxisystem.site/public_html/test_kill2.php', (err, stream) => {
                if (err) throw err;
