...
class CodingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLogController::log('Created Coding Rule', "Day: {$data['coding_day']}\nType: " . ucwords($data['coding_type']) . "\nPlates: {$data['restricted_plate_numbers']}");
    ...
    public function update(Request $request, $id)
    {
        ...
        ActivityLogController::log('Updated Coding Rule', "Rule ID: {$id}\nDay: {$data['coding_day']}\nStatus: " . ucfirst($data['status']));
    ...
    {
        $rule = DB::table('coding_rules')->where('id', $id)->first();
        $day = $rule->coding_day ?? 'Unknown';
        
        DB::table('coding_rules')->where('id', $id)->delete();

        ActivityLogController::log('Deleted Coding Rule', "Rule for {$day} has been removed.");
    ...
    public function updateCodingDay(Request $request)
    {
        ...
        ActivityLogController::log('Updated Unit Coding Day', "Unit: {$plate}\nNew Day: {$request->coding_day}");
