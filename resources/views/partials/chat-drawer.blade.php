...
<div id="chatDrawer"
    ...
    <div id="chatThread" class="hidden flex-col" style="max-height: 420px;">
        <div id="staffChatMessages" class="flex-1 overflow-y-auto px-4 py-3 space-y-3" style="min-height: 280px; max-height: 320px;"></div>
        <div class="border-t bg-white px-3 py-3 flex gap-2" style="padding-right: 80px;">
            <input type="text" id="staffChatMessageInput"
