                        ...
                        <div class="flex gap-4">
                            ...
                            <p class="text-sm text-indigo-100/90 leading-relaxed">
                                ...
                                @if($fleet_utilization < 80)
                                    This is <span class="text-rose-300 font-bold underline">below optimal levels</span>. You are losing approximately ₱{{ number_format($fleet_pulse['idle_units'] * 1200) }} in daily potential revenue.
                                @else
